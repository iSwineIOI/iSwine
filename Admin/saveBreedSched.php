...
$sql = "UPDATE sowrecord SET Boar_ID = '$Boar_ID', BreedingDate = '$breedDate', ExBreedDate = '$ExBreedDate',status = '$status', used = '$newCount',ExpectedDate = '$ExpectedDate',DateFarrow = '$DateFarrow',litterSize = '$litterSize',DateWeaning = '$DateWeaning',UponWeaning = '$UponWeaning',AverageWW = '$AverageWW' WHERE Sow_ID = '$Sow_ID'";
