  ...
  <section id="container">
              ...
              <div class="row">
                            ...
                            <div class="col-lg-3">
                                <div class="form-group ic-cmp-int">
                                    ...
                                    <div class="form-group ">
                                    <button type="button" class="btn btn-round btn-primary" style="padding-right: 35px !important;padding-left: 35px !important" id="form_ation" onclick="saveProduct(this)"><i class="fa fa-plus"></i> Add to table</button> 
                                    </div>
                                </div>
                            </div>
                        </div>  
      ...
      <section id="main-content" >
          <section class="wrapper">
              ...
              <?php
              $read = "SELECT * FROM Inventory_table ORDER BY product_ID DESC LIMIT 10";
              ...
              <tr>
                  <th width="40">
                    <label><?php echo $list['product_ID']?></th> 
                    <td><?php echo $list['product_name'] ?> </label>
                    <small style="float: right;"><?php echo $list['product_type'] ?> </small>
                  </td>
              </tr>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group ic-cmp-int">
                                    ...
                                    <div class="form-group">
                                        <input type="hidden" id="product_ID" name="product_ID" class="form-control" placeholder="Enter amount">
                                        <input type="number" id="useProduct" name="useProduct" class="form-control" placeholder="Enter amount">
                                        <span id="error_date" class="text-danger"></span>
                                    </div>
                                </div>
                            </div>
    ...
    <script type="text/javascript">
        ...
        function updatePrduct(){
            ...
            $.ajax({
                url: 'getproduct_ID.php',
                method: 'post',
                data:{'geveID':geveID,'product_ID':product_ID,'product_type_e':product_type_e,'product_name_e':product_name_e,'measurement_e':measurement_e,'quantity_e':quantity_e},
                success:function(data){
                    if (data == 'updated')
                    {
    ...
    <script type="text/javascript">
        ...
        function USEproduct(){
            ...
            else
            {
                ...
                url: 'getproduct_ID.php',
                method: 'post',
                data:{'geveID':geveID,'product_ID':product_ID,'amount':amount,'Sow_ID':Sow_ID,'swine_type':swine_type,'today':today     },
                success:function(data){
                    //alert(data);
                        if (data == "use")
                        {
...
//--------------------------------------------------------------------------------------------------------------------------
              if ( product_name != '' || quantity != '')
              {
                 $.ajax({
                  ...
                  method: 'POST',
                  data: {'product_name': product_name,'measurement':measurement,'quantity':quantity,'product_type':product_type},
                  success:function(data)
                  {
                    //alert(data);
                    if(data == 'success')
