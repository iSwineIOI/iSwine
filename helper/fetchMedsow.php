...
$output = '
	  ...
	  <thead>
	  	<tr>
	  		<th width="275">Sow ID</th>
	  		<th class="hidden-phone"width="275">Breed Type</th>
	  		<th class="hidden-phone"width="275">Date of birth</th>
	  		<th>Action</th>
	  	</tr>
	  </thead>
	  <tbody>
		...
		$output .= '
			<tr>
				...
				<td>
					...
					<button type="button" name="edit" class="btn btn-sm btn-success " id="'.$row["Sow_ID"].'" onclick="viewPres(this)"><i class="fa fa-eye"></i> Prescription ';
