                          ...
                          <div class="col-lg-3">
                            ...
                            <div class="col-lg-3 right">
                                <div class="form-group ic-cmp-int">
                                    ...
                                    <div class="form-group ">
                                    <button type="button" class="btn btn-round btn-primary" style="padding-right: 35px !important;padding-left: 35px !important" id="form_ation" onclick="saveSow(this)"><i class="fa fa-plus"></i> Add to table</button> 
                                    </div>
                                </div>
                            </div>
                        </div>  
          ...
          <section class="wrapper">
              ...
              <table class="table table-striped table-bordered">
                <tr>
                  <th width="40">
                    <label>ID</label></th> 
                    <td><label>Breed</label>
                    <label style="float: right;">Add breeding Schedule</label>
                  </td>
              </tr>
              </table>
              <table class="table table-bordered">
              <?php
              $read = "SELECT * FROM sowrecord ORDER BY Sow_ID DESC LIMIT 10";
              $run = mysqli_query($mysqli,$read);
              while($list = mysqli_fetch_array($run))
              {
              ?>
              <tr>
                  <th width="40">
                    <label><?php echo $list['Sow_ID']?></th> 
                    <td><?php echo $list['Breed'] ?> </label>
                    <button style="float: right;" type="button" name="delete" class="btn btn-sm btn-primary Addbreed" id="</php <?php echo $row["Sow_ID"]?>" onclick="addbreed(this)" data-toggle="modal" href="#addbreed"><i class="fa fa-plus"></i> Add
                    <?php
                    if ($list['used'] == 0)
                    {
                        echo '<span style="color:white; margin-top:0;" class="badge badge-warning">New</span>';
                    }
                    else
                    {
                        echo '<span style="color:white; margin-top:0;" class="badge badge-default">'.$list["used"].'</span>';
                    }
                    ?></button>
                  </td>
              </tr>
                        ...
                        <div class="row" id="addFarrowed" style="">
                            ...
                            <div class="col-lg-4">
                                <div class="form-group ic-cmp-int">
                                    ...
                                    <div class="form-group">
                                        <label> Weight</label>
                                        <input type="number" id="UponWeaning" value="" name="UponWeaning" class="form-control" onchange="getValuee()" placeholder="Upon weaning" >
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group ic-cmp-int">
                                    ...
                                    <div class="form-group">
                                        <label> Average </label>
                                        <input type="number" id="AverageWW" name="AverageWW" class="form-control" placeholder="Weaning weight" readonly>
                                    </div>
                                </div>
                            </div>
                        </div>
  ...
  <script type="text/javascript">
      function saveBreed(button){
        ...
        $.ajax({
            ...
            method: 'post',
            data:{'breedDate':breedDate,'ExBreedDate':ExBreedDate,'status':status,'Sow_ID':Sow_ID,'ExpectedDate':ExpectedDate,'DateFarrow':DateFarrow,'litterSize':litterSize,'DateWeaning':DateWeaning,'UponWeaning':UponWeaning,'AverageWW':AverageWW},
            success:function(data){
                //alert(data);
                if(data == 'success')
                {
