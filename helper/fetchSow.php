...
$output = '
	  ...
	  <thead>
	  	<tr>
	  		...
	  		<th class="hidden-phone"width="180">Cage Number</th>
	  		<th class="hidden-phone"width="180">Breed type</th>
	  		<th class="hidden-phone"width="180">Date of birth</th>
	  		<th width="240">Breeding result</th>
	  		<th>Action</th>
	  	</tr>
	  </thead>
	  <tbody>
	...
	foreach ($result as $row)
	{
		...
		$output .= '
			<tr>
				...
				<td class="hidden-phone">'.$row["ExpectedDate"].'</td>
				<td align="right">
				';
