...
<form method="post" action="InsertValidate.php">
  <div class="container">
                    ...
                    <div class="container">
                        <div class="carousel-position-four text-center">
                            <h2 class="margin-bottom-20 animate-delay carousel-title-v3 border-bottom-title text-uppercase" data-animation="animated fadeInDown">
                                100% <br/><span class="color-red-v2">Guaranteed</span><br/> Fine meat!
                            </h2>
                            <p class="carousel-subtitle-v2" data-animation="animated fadeInUp">We make sure to monitor the swine daily <br/>
                            in order to achieve fine and good quality meat.</p>
                        </div>
                    </div>
                </div>
                   ...
                   <div class="center-block">
                        <div class="center-block-wrap">
                            <div class="center-block-body">
                                ...
                                <a class="carousel-btn" href="#" data-animation="animated fadeInUp">Order Now!</a>
                            </div>
                        </div>
                    </div>
                </div>
  ...
  function viewImageSell(a){
      ...
      $.ajax({
        ...
        success:function(data)
        {
          ...
          $("#swineType").html("Swine Type: "+data.swine_type);
        ...
        <div class="col-md-6 col-sm-12 col-xs-12">
          ...
          <div class="row">
            <div class="col-md-6">
              ...
              <a style="display: ;" onclick="addToCart(this)" class="btn btn-primary" id="post_id">Add to cart</a><hr>
              <span style="display: none;" id="login1st">You must login first.</span>
            </div>
            <div class="col-md-6">
            </div>
          </div>
  ...
  function viewImageSale(a){
      ...
      $.ajax({
        ...
        success:function(data)
        {
          ...
          $("#swineType_sale").html("Swine Type: "+data.swine_type);
          var pPrice = data.price;
          var newPrice = new Intl.NumberFormat("en-US",{
            style:"currency",
            currency: "PHP"
    ...
    <div class="product-page product-pop-up">
      <div class="row">
        ...
        <div class="col-md-6 col-sm-12 col-xs-12">
          ...
          <div class="row">
            <div class="col-md-6">
              <input type="hidden" id="post_id_sale" name="">
...
<!-- Modal  for login b4 order-------------------------------------------------------------------------------------------->
    ...
    <div class="modal fade" id="message" tabindex="-10" role="dialog" aria-hidden="true">
      <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
          <div class="modal-header">
          </div>
    ...
    $.ajax({
      ...
      success:function(data)
      {
        ...
        if (data == cartID)
        {
          ...
          var c = document.getElementById("login1st");
